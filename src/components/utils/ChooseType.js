...
const ChooseType = ({type, handleChange}) => {
    ...
    return <>
        {type.map((type,i) => {
            return <div key={type} className='col-6 value' style={{ padding: "2px", position: "relative" }}>
                <div key={type} className="choose"><Type  type={type} /></div>
        ...
        {type.length < 2 && <>
            <div className="col-6 value" style={{ padding: "2px" }}>    
                <DropdownButton title="" style={{ margin: "2px", borderRadius: "20px", border: "solid", borderWidth: "1px", color: "white", fontWeight: "bold" }}>
